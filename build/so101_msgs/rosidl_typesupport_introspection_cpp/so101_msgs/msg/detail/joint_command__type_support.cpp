...
{
  new (message_memory) so101_msgs::msg::JointCommand(_init);
}

void JointCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<so101_msgs::msg::JointCommand *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember JointCommand_message_member_array[4] = {
  {
    ...
    offsetof(so101_msgs::msg::JointCommand, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(so101_msgs::msg::JointCommand, joint_names),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(so101_msgs::msg::JointCommand, velocities),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(so101_msgs::msg::JointCommand, control_mode),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers JointCommand_message_members = {
  ...
  4,  // number of fields
  sizeof(so101_msgs::msg::JointCommand),
...
get_message_type_support_handle<so101_msgs::msg::JointCommand>()
{
  return &::so101_msgs::msg::rosidl_typesupport_introspection_cpp::JointCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, so101_msgs, msg, JointCommand)() {
  return &::so101_msgs::msg::rosidl_typesupport_introspection_cpp::JointCommand_message_type_support_handle;
}
