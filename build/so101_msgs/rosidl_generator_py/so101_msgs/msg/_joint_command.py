...
class Metaclass_JointCommand(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'FROZEN_TRANSLATION': cls.__constants['FROZEN_TRANSLATION'],
        }

    @property
    def NORMAL(self):
        """Message constant 'NORMAL'."""
        return Metaclass_JointCommand.__constants['NORMAL']

    @property
    def FROZEN_TRANSLATION(self):
        """Message constant 'FROZEN_TRANSLATION'."""
        return Metaclass_JointCommand.__constants['FROZEN_TRANSLATION']
