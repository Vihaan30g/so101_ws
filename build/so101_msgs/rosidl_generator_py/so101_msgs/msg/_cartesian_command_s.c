...
bool so101_msgs__msg__cartesian_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("so101_msgs.msg._cartesian_command.CartesianCommand", full_classname_dest, 50) == 0);
  }
  so101_msgs__msg__CartesianCommand * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of CartesianCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("so101_msgs.msg._cartesian_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CartesianCommand");
