...
#include "so101_msgs/msg/detail/joint_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const so101_msgs::msg::JointCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  so101_msgs::msg::JointCommand & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = so101_msgs::msg::JointCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const so101_msgs::msg::JointCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<so101_msgs::msg::JointCommand *>(
    untyped_ros_message);
...
{
  return &so101_msgs::msg::typesupport_fastrtps_cpp::_JointCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, so101_msgs, msg, JointCommand)() {
  return &so101_msgs::msg::typesupport_fastrtps_cpp::_JointCommand__handle;
}
