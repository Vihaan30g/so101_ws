...
#include "so101_msgs/msg/detail/joint_command__rosidl_typesupport_fastrtps_c.h"
...
using _JointCommand__ros_msg_type = so101_msgs__msg__JointCommand;
...
size_t get_serialized_size_so101_msgs__msg__JointCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _JointCommand__ros_msg_type * ros_message = static_cast<const _JointCommand__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _JointCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_so101_msgs__msg__JointCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_so101_msgs
size_t max_serialized_size_so101_msgs__msg__JointCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = so101_msgs__msg__JointCommand;
    is_plain =
      (
...
static size_t _JointCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_so101_msgs__msg__JointCommand(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, so101_msgs, msg, JointCommand)() {
