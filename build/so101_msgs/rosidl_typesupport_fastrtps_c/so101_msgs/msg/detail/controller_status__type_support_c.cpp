...
#include "so101_msgs/msg/detail/controller_status__rosidl_typesupport_fastrtps_c.h"
...
using _ControllerStatus__ros_msg_type = so101_msgs__msg__ControllerStatus;
...
size_t get_serialized_size_so101_msgs__msg__ControllerStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ControllerStatus__ros_msg_type * ros_message = static_cast<const _ControllerStatus__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ControllerStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_so101_msgs__msg__ControllerStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_so101_msgs
size_t max_serialized_size_so101_msgs__msg__ControllerStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = so101_msgs__msg__ControllerStatus;
    is_plain =
      (
...
static size_t _ControllerStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_so101_msgs__msg__ControllerStatus(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, so101_msgs, msg, ControllerStatus)() {
